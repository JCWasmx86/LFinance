namespace LFinance {
	internal class EncryptionSetupDialog : Gtk.Dialog {
		...
		void build_gui() {
			this.add_buttons(_("_Cancel"), Gtk.ResponseType.CANCEL, _("Encrypt Data"), Gtk.ResponseType.OK);
			this.get_widget_for_response(Gtk.ResponseType.OK).get_style_context().add_class("destructive-action");
